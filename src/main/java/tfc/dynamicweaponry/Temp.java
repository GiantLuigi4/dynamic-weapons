...
public class Temp {
	...
	static {
		try {
			Material gray = new Material(new ClientMaterial(0, 0, 0, new ResourceLocation("dynamic_weaponry:oak")));
			Material gold = new Material(new ClientMaterial(0, 0, 0, new ResourceLocation("dynamic_weaponry:gold")));
